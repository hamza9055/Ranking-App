    ...
    return (
         (items != null)?
            <main>
                ...
                {/* <button onClick={Reload} className="reload" style={{ "marginTop": "10px" }}> <span className="text" ><ReloadOutlined/>Reload</span > </button> */}
                
                <div className="reload"  onClick={Reload}>
                <ReloadOutlined className='reload-icon'/><span>Reload</span>
